...
def manage_natural_magic():
    ...
    natmag_learn_sub.bytestring = [0x22, 0x73, 0x08, 0xF0]
...
def manage_skips():
    ...
    boat_skip_sub.bytestring = (
        ...
        [0x3D, 0x03, 0x3F, 0x03, 0x01, 0x45, 0x77, 0x03] +    # Create Shadow, add Shadow to party 1, refresh objects, level average Shadow
        # clear NPC bits
