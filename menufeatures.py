...
def add_common_menu_stuff(fout):
    ...
    0xAA, # TAX
    0xA9, 0x07, 0x00, # LDA #$07
    0xE2, 0x20, # SEP #$20
    0x6B, # RTL
    # $F01871 Write Name of attack?:
    0xA5, 0x35, # LDA $35
    0x85, 0x38, # STA $38
    0x22, 0x21, 0x18, 0xF0, # JSR #$F01821
    0x86, 0x38, # STX $38
...
def _rage_dance_common(fout):
    ...
    0xA5, 0x27, # LDA $27
    0xAA,   # TAX
    0xBF, 0x80, 0xFE, 0xCF, # LDA $CFFE80,X
    0x85, 0x2E, # STA $2E
    0xA5, 0x2E, # LDA $2E
    0x85, 0x35, # STA $35
    0xA0, 0x9B, 0x42,   # LDY #$429B
    0x84, 0x36, # STY $36
    0x22, 0x71, 0x18, 0xF0, # JSR $F01871
    0x18, 0xA5, 0x27, 0x69, 0x01, 0x85, 0x2D, 0xA5, 0x2D,
    0x85, 0x27, 0xA5, 0x27, 0xAA,
    0xBF, 0x80, 0xFE, 0xCF, # LDA $CFFE80,X
    0x85, 0x30, # STA $30
    0xA5, 0x30, # LDA $30
    0x85, 0x35, # STA $35
    ...
    0x18, # CLC
    0xA5, 0x27, # LDA $27
    0x69, 0x01, 0x85, 0x2F, 0xA5, 0x2F, 0x85, 0x27, 0xA5,
    0x27, 0xAA,
    0xBF, 0x80, 0xFE, 0xCF, # LDA $CFFE80,X
    0x85, 0x32, # STA $32
    0xA5, 0x32, # LDA $32
    ...
    0x22, 0x71, 0x18, 0xF0, # JSR $F01871
    0x18, 0xA5, 0x27,
    0x69, 0x01, 0x85, 0x31, 0xA5, 0x31, 0x85, 0x27, 0xA5, 0x27, 0xAA,
    0xBF, 0x80, 0xFE, 0xCF, # LDA $CFFE80,X
    0x85, 0x34, # STA $34
    0xA5, 0x34, # LDA $34
    0x85, 0x35, # STA $35
    ...
    0x84, 0x36, # STY $36
    0x22, 0x71, 0x18, 0xF0, # JSR $F01871
    0x18, 0xA5, 0x27, 0x69, 0x01, 0x85,
    0x33, 0xA5, 0x33, 0x85, 0x27,
    0x6B, 
    0xAD, 0x00, 0x01, 0x85, 0x12, 0xA5,
