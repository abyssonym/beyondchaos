...
def improve_gogo_status_menu(fout):
    ...
    status_sub.bytestring = bytes([0xAF, 0x89, 0x9D, 0x7E, 0xC9, 0x0F, 0x90, 0x02,
...
def improve_rage_menu(fout):
    ...
    rage_sub.bytestring = bytes([0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x04, 0x02,
...
def show_original_names(fout):
    ...
    names_sub.bytestring = bytes([0xA2, 0x31, 0x37, 0x86, 0xF1, 0xDA, 0x5A, 0xA6,
