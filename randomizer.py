...
from dialoguemanager import get_dialogue, manage_dialogue_patches, read_battle_messages, read_dialogue, read_location_names, set_dialogue, write_battle_messages, write_location_names
...
from strangejourney import activate_strange_journey
...
-   Use all flags EXCEPT the ones listed'''
    ...
    if options_.is_code_active('strangejourney') and not options_.is_code_active('ancientcave'):
        activate_strange_journey(fout, sourcefile)
    reseed()
