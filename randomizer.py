...
def manage_item_display(command_changer_dict):
    display_sub = Substitution()
    display_sub.set_location(0x38706)
    display_sub.bytestring = [0x22, 0xA0, 0xF0, 0xC3]
    display_sub.write(fout)

    fm_before, fm_after = command_changer_dict["FakeMustache"]
    display_sub.set_location(0x3F0A0)
    display_sub.bytestring = [0xDA, 0x5A, 0xA9, 0xC3, 0xA0, 0xB7, 0xF0, 0xA2, 0xEF, 0x80, 0x20,
    0xF0, 0xF4, 0x20, 0xC0, 0xF0, 0x7A, 0xFA, 0xBF, 0x00, 0x50, 0xD8, 0x6B,
    0x84, 0x9F, 0x9F, 0x9E, 0x9C, 0xAD, 0xAC, 0xC1, 0x00, # Effects:
    , # 1/2 enc.
    0xA7, 0xA8, 0xFF, 0x9E, 0xA7, 0x9C, 0xC5, 0x00, # no enc.
    ...
    0xD5, 0xFF, 0x89, 0xAE, 0xA6, 0xA9, 0x00, # -> Jump
    0xD5, 0xFF, 0x97, 0xC4, 0x8C, 0x9A, 0xA0, 0xA2, 0x9C, 0x00 # -> X-Magic
    ] + map(lambda c: hex2int(shorttexttable[c]), fm_before[:7]) + [0xD5] + map(lambda c: hex2int(shorttexttable[c]), fm_after[:7]) + [0x00] * (16 - len(fm_after[:7]) - len(fm_before[:7])) + [ # -> Control
    0xD5, 0xFF, 0x86, 0x8F, 0xFF, 0xAB, 0x9A, 0xA2, 0xA7, 0x00, # -> GP rain
    0xD5, 0xFF, 0x82, 0x9A, 0xA9, 0xAD, 0xAE, 0xAB, 0x9E, 0x00, # -> Capture
    ...
    0x8B, 0xA8, 0xB0, 0xFF, 0xA1, 0xA9, 0xFF, 0x92, 0xA1, 0x9E, 0xA5, 0xA5, 0x00, # Low hp shell
    0x8B, 0xA8, 0xB0, 0xFF, 0xA1, 0xA9, 0xFF, 0x92, 0x9A, 0x9F, 0x9E, 0x00, # Low HP safe
    ...
    0x94, 0xA7, 0xA4, 0xA7, 0xA8, 0xB0, 0xA7, 0x00, # Unknown
    ]
    display_sub.write(fout)
...
-   Use all flags EXCEPT the ones listed'''
    ...
    command_changer_dict = {
        "Dragoon Boots":("Fight", "Jump"),
        "Gem Box":("Magic","X-Magic"),
        "FakeMustache":("Sketch", "Control"),
        "Coin Toss": ("Slot", "GP Rain"),
        "Thief Glove": ("Steal", "Capture")
        }
    if 'q' in flags:
        # do this after swapping beserk
        from itemrandomizer import set_item_changed_commands
        ...
        for name, before, after in loglist:
            ...
            command_changer_dict[name] = (beforename, aftername)
    ...
    manage_item_display(command_changer_dict)
