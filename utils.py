...
def generate_character_palette(skintones_unused=None, char_hues_unused=None, trance=False):
    ...
    if not trance:
        ...
        new_palette[2] = components_to_color(hsv_approx(nudge_hue(hair_hue), random.randint(80,100), random.randint(93,100)))
        new_palette[3] = components_to_color(hsv_approx(nudge_hue(hair_hue), random.randint(10,100), random.randint(10,25)))
